...
import json
from .routes import auth_routes, interview_routes, upload_resume, generate_mcq_route, email_routes, candidate_routes, mcq_report_generation_route
...
app.include_router(mcq_report_generation_route.router)
